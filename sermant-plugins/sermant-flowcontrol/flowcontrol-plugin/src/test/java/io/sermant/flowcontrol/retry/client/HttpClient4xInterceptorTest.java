...
public class HttpClient4xInterceptorTest {
    ...
    public void test() throws NoSuchMethodException {
        ...
        XdsCircuitBreakerManager.decreaseActiveRequests(scenario.getServiceName(), scenario.getClusterName());
        XdsCircuitBreakerManager.decreaseActiveRequests(scenario.getServiceName(), scenario.getClusterName());

        // Test normal invocation without triggering flow control rules
        interceptor.doBefore(executeContext);
        System.out.println(JSONObject.toJSONString(executeContext.getResult()));
    }
